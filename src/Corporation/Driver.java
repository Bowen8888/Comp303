...
public final class Driver
{
	...
	private static final Item ITEM_CEREAL = new NormalItem("Cereal", 1, 200);
	private static final Item ITEM_JAM = new NormalItem("Jam", 2, 400);
	private static final Item ITEM_BUTTER = new NormalItem("Butter", 3, 250);
