package LuckyNumberWtihNotifyButton;
...
public class LuckyNumber extends Application
{
    ...
    public void start(Stage pPrimaryStage) 
    {
    	...
    	button.setText("NotifyObservers");
    	GridPane root1 = new GridPane();
    	root1.getChildren().add(button);
    	root.add(root1, 0, 3, 1, 1);
 ...
 */
class IntegerPanel extends HBox implements Observer, EventHandler<ActionEvent>
{
	...
	IntegerPanel(Model pModel)
	{
		...
		aText.setOnKeyReleased(new EventHandler<KeyEvent>(){
